...
export default function QuotedMessage({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        'flex items-start gap-2 p-2 rounded-lg mb-2 cursor-pointer transition-colors',
        isOwn
    ...
    >
      <Reply
        className={cn(
          ...
          isOwnReply ? 'text-primary' : 'text-muted-foreground',
        )}
      />
      <div className='min-w-0 flex-1'>
        <p
          className={cn(
            ...
            isOwnReply ? 'text-primary' : 'opacity-70',
          )}
        >
