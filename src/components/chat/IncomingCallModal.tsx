...
export default function IncomingCallModal() {
  ...
  useEffect(() => {
    if (isRinging) {
      // Create ringtone audio (using Web Audio API for oscillator tone)
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Call type indicator */}
          <motion.div
            className='mb-8 flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border'
